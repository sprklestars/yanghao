...
def upgrade() -> None:
    ...
    op.create_table('accounts',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('platform', sa.Enum('TELEGRAM', 'FACEBOOK', 'ZALO', name='platform'), nullable=False),
        ...
        sa.Column('health', sa.Enum('GREEN', 'YELLOW', 'RED', 'BLACK', name='accounthealth'), nullable=False),
    ...
    op.create_table('tasks',
        ...
        sa.Column('platform', sa.Enum('TELEGRAM', 'FACEBOOK', 'ZALO', name='platform'), nullable=False),
        sa.Column('category', sa.Enum('PRIVATE_INVESTIGATOR', 'CURRENCY_EXCHANGER', 'FREELANCER', 'DATA_SELLER', name='intelligencecategory'), nullable=False),
        ...
        sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'PAUSED', 'COMPLETED', 'FAILED', name='taskstatus'), nullable=False),
    ...
    op.create_table('conversations',
        ...
        sa.Column('state', sa.Enum('IDLE', 'GREETING', 'PROBING', 'EXTRACTION', 'PIVOT', 'EXIT', 'COOLDOWN', name='conversationstate'), nullable=False),
    ...
    op.create_table('intelligence_records',
        ...
        sa.Column('activity_status', sa.Enum('ACTIVE', 'DORMANT', 'INACTIVE', name='activitystatus'), nullable=False),
        sa.Column('last_seen', sa.DateTime(timezone=True), nullable=True),
        sa.Column('response_rate', sa.Float(), nullable=True),
        sa.Column('review_status', sa.Enum('PENDING', 'REVIEWED', 'APPROVED', 'REJECTED', name='reviewstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_intelligence_records_dedup_fingerprint'), 'intelligence_records', ['dedup_fingerprint'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_intelligence_records_dedup_fingerprint'), table_name='intelligence_records')
