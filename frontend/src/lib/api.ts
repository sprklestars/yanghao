 ...
 * 页面据此切到演示模式，但重连仍会继续，后端起来后自动恢复实时数据。
 */
...
// ─────────────────────────────────────────────────────
// 演示数据（后端不可达 / 数据库为空时的降级显示）
// ─────────────────────────────────────────────────────

const daysAgo = (days: number) =>
  new Date(Date.now() - days * 24 * 60 * 60 * 1000).toISOString();

const DEFAULT_POLICY: ReplyPolicy = {
  private: true,
  groups: false,
  channels: false,
  bots: false,
...
export const DEMO_ACCOUNTS: Account[] = [
  {
    ...
    platform: 'telegram',
    username: '@printer',
    display_name: 'Printer（演示）',
    health: 'green',
    reply_policy: { ...DEFAULT_POLICY },
    paused: false,
    persona: 'designer',
    ...
    session_file: 'printer.session',
  },
  {
    id: 'user3',
    platform: 'telegram',
    username: '@user3',
    display_name: 'User3（演示）',
    health: 'green',
    reply_policy: { ...DEFAULT_POLICY },
    paused: false,
    persona: 'trader',
    ...
    last_action_at: daysAgo(0),
    session_file: 'user3.session',
  },
  {
    id: 'user4',
    platform: 'telegram',
    username: '@user4',
    display_name: 'User4（演示）',
    health: 'yellow',
    reply_policy: { ...DEFAULT_POLICY },
    paused: true,
    persona: 'student',
...
export const DEMO_CONVERSATIONS: Conversation[] = [
  {
    id: 'demo-conv-1',
    account_id: 'printer',
    task_id: 'task-auto-telegram',
    target_user_id: '8801001',
    target_display_name: 'Nguyễn Văn A',
    state: 'extraction',
    turn_count: 8,
    context_summary:
      '对方自称做换汇，主要收 USD/VND，已在对话中报出汇率与 Zalo 号，信任度中等。',
    ...
    messages: [
      ...
      },
      {
        id: 'demo-msg-4',
        direction: 'inbound',
        content: 'Bạn cần đổi bao nhiêu? Giá hôm nay 25,500 VND/USD nhé.',
        created_at: daysAgo(1),
      },
    ],
  },
  {
    ...
    account_id: 'printer',
    task_id: 'task-auto-telegram',
    target_user_id: '8801002',
    target_display_name: 'Trần Thị B',
    state: 'probing',
    turn_count: 4,
    context_summary: '对方在做自由职业外包，正在了解其接单范围与报价方式。',
    ...
    messages: [
      {
        id: 'demo-msg-5',
        direction: 'outbound',
        content: 'Chào bạn! Mình thấy bạn có đăng bài nhận dự án thiết kế web đúng không?',
        created_at: daysAgo(0),
      },
      {
        id: 'demo-msg-6',
        direction: 'inbound',
        content: 'Đúng rồi, mình nhận design và lập trình web nhé.',
        created_at: daysAgo(0),
      },
    ],
  },
...
export const DEMO_INTELLIGENCE: IntelligenceRecord[] = [
  {
    id: 'demo-intel-1',
    task_id: 'task-auto-telegram',
    platform: 'telegram',
    ...
    confidence: 0.85,
    signals: ['quotes exchange rate', 'shares contact'],
    extracted_contacts: {
      phones: ['+84123456789'],
      zalo_ids: ['zalo.me/doitienA'],
      telegram_handles: ['@doitienA'],
    },
    business_info: {
      service_description: 'Đổi tiền USD/VND',
      prices: ['25,500 VND/USD'],
    },
  ...
  },
  {
    ...
    category: 'freelancer',
    confidence: 0.72,
    signals: ['mentions portfolio', 'offers service'],
    extracted_contacts: { telegram_handles: ['@tranthib'] },
    business_info: { service_description: 'Thiết kế & lập trình web' },
    activity_status: 'active',
    review_status: 'pending',
    last_seen: daysAgo(0),
    collected_at: daysAgo(0),
  },
];
